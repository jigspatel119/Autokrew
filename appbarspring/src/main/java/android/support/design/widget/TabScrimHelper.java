...
public class TabScrimHelper implements AppBarLayout.OnOffsetChangedListener {
    ...
    public TabScrimHelper(TabLayout tabLayout, CollapsingToolbarLayout toolbarLayout) {
        ...
        mSelectedColor = colorStateList.getColorForState(new int[]{android.R.attr.state_selected},
    ...
    private void initDefault() {
        ...
        mCollapseTabBackgroundColor = Color.parseColor("#424242"); //background color
        mCollapseTabNormalTextColor = Color.parseColor("#FFFFFF"); //text color
        mCollapseTabSelectTextColor = Color.parseColor("#FFFFFF"); //selected text color
    }
