...
import com.autokrew.fragments.LeaveRegisterFragment;
...
public class LeaveActivity extends AppCompatActivity{
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new LeaveRequestFragment(), "Leave Request");
        adapter.addFrag(new LeaveRegisterFragment(), "Leave Register");
