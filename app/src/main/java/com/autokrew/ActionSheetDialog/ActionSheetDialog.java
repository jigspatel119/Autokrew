package com.autokrew.ActionSheetDialog;
...
public class ActionSheetDialog extends BottomBaseDialog<ActionSheetDialog> {
     ...
     */
    private int mTitleBgColor = Color.parseColor("#4DAFDE");
    /**
     * title text(标题)
     */
    private String mTitle = "Share";
    /**
     * title height(标题栏高度)
     */
     ...
     */
    private float mItemTextSize = 18.5f;
    /**
     ...
     */
    private int mCancelTextColor = Color.parseColor("#000000"); //default was #44A2FF
    /**
     * cancel btn text size(取消按钮文字大小)
     */
    private float mCancelTextSize = 18.5f;
    /**
     * adapter(自定义适配器)
     */
    ...
    public void setOnOperItemClickL(OnOpenItemClickL onOpenItemClickL) {
        mOnOpenItemClickL = onOpenItemClickL;
    }
