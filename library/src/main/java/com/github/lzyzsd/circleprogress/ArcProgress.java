...
public class ArcProgress extends View {
    ...
    private String suffixText = "Rs";
    private float suffixTextPadding;

    private float arcBottomHeight;

    private final int default_finished_color = Color.rgb(248,87,0);
    private final int default_unfinished_color = Color.WHITE;

    private final int default_text_color = Color.rgb(55,58,91);
    ...
    public float default_text_size = 18;
    private final int min_size;

    public float default_text_size2 = 56;
    public float suffix_text_padding2 = 28;
